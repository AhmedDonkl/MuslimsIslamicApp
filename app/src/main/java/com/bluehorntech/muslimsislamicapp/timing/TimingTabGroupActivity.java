...
public class TimingTabGroupActivity extends ActivityGroup {

    private static final String ACTIVITY_TAG = "TIMING_ACTIVITY";
	private ArrayList<String> activityList;
	@Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        activityList = new ArrayList<String>();
        startChildActivity(ACTIVITY_TAG, new Intent(this, TimingActivity.class));
