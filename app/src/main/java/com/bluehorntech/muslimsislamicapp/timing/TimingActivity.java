...
public class TimingActivity extends Activity implements LocationListener, OnCheckedChangeListener, OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(ifarzSharedPref.getString(ConstantsClass.LOCATION_NAME, "").equals(""))
			gpsTracker = new GPSTracker(TimingActivity.this,TimingActivity.this);
	...
	private void setAlarm() {
		...
		if(namzTag!=0)
		{
			...
			PendingIntent pendingIntent = PendingIntent.getBroadcast(getParent()
					, 86968, new Intent(getParent()
	...
	private void setScreenViews() {
		...
		textViewFajarTime = (TextView)findViewById(R.id.textView_fajar_namz_time);
		textViewFajarTime.setOnClickListener(this);
		textViewShrkTime = (TextView)findViewById(R.id.textView_shrouk_namz_time);
		textViewShrkTime.setOnClickListener(this);
		textViewZohrTime = (TextView)findViewById(R.id.textView_zohr_namz_time);
		textViewZohrTime.setOnClickListener(this);
		textViewAsrTime = (TextView)findViewById(R.id.textView_asr_namz_time);
		textViewAsrTime.setOnClickListener(this);
		textViewMaghribTime = (TextView)findViewById(R.id.textView_maghrib_namz_time);
		textViewMaghribTime.setOnClickListener(this);
		textViewEshaTime = (TextView)findViewById(R.id.textView_isha_namz_time);
		textViewEshaTime.setOnClickListener(this);
		
		checkBoxFajar = (CheckBox)findViewById(R.id.checkbox_fajar_timer);
		checkBoxFajar.setOnCheckedChangeListener(this);
		checkBoxShrouk = (CheckBox)findViewById(R.id.checkbox_shrouk_timer);
		checkBoxShrouk.setOnCheckedChangeListener(this);
		checkBoxZohr = (CheckBox)findViewById(R.id.checkbox_zohr_timer);
		checkBoxZohr.setOnCheckedChangeListener(this);
		checkBoxAsr = (CheckBox)findViewById(R.id.checkbox_asr_timer);
		checkBoxAsr.setOnCheckedChangeListener(this);
		checkBoxMaghrib = (CheckBox)findViewById(R.id.checkbox_maghrib_timer);
		checkBoxMaghrib.setOnCheckedChangeListener(this);
		checkBoxIsha = (CheckBox)findViewById(R.id.checkbox_isha_timer);
