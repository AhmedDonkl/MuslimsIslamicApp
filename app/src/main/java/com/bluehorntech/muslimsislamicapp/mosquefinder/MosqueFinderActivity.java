...
public class MosqueFinderActivity extends Activity implements OnClickListener, LocationListener, OnScrollListener, OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setScreenViews();
		loadingPrgresBAr = new ProgressDialog(getParent());
	...
	private void setScreenViews() {
		...
		mosquesListAdaptor = new MosquesListAdaptor(getParent());
...
//			btnLoadMore.invalidate();
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		Intent mapActivityIntent = new Intent(getParent(),MapDirectionDisplayActivity.class);
