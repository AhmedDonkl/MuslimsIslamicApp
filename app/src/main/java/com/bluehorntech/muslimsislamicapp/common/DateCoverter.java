...
public class DateCoverter {
	...
	static double[] GregorianToHijri(boolean adjust,int yearGre, int monthGre, int dayGre ) {
...
//		}
	...
	public static  int[] GregorianToHijri(String year, String month, String day)
	{
		int[] convertedDateArr = null;
		try {
			double[] tempArry = GregorianToHijri(true,Integer.valueOf(year),Integer.valueOf(month),Integer.valueOf(day));
			 convertedDateArr = new int[3];
			convertedDateArr[0] = (int) tempArry[5];
			convertedDateArr[1] = (int) tempArry[6];
			convertedDateArr[2] = (int) tempArry[7];
		} catch (Exception e) {
		}
